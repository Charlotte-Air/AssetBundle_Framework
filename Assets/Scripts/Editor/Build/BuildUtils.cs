...
public class BuildUtils
{
    ...
    public static void BuildNormalCfgBundle(string targetPath)
    {
        ...
        tb["normal_cfg.bundle"] = "AssetBundle/Config";
    ...
    public static void BuildLuaBundle(string targetPath)
    {
        ...
        {
            Application.dataPath + "/AssetBundle/LuaScripts",
        }, true);
    ...
    {
        Hashtable tb = new Hashtable();
        tb["ui.bundle"] = "AssetBundle/UI";
        tb["audio.bundle"] = "AssetBundle/Audio";
        tb["model.bundle"] = "AssetBundle/Model";
        tb["scenes.bundle"] = "AssetBundle/Scenes";
        AssetBundleBuild[] buildArray = MakeAssetBundleBuildArray(tb);
        BuildBundles(buildArray, targetPath);
    }
    ...
    public static void GenOriginalLuaFrameworkMD5File()
    {
        ...
        using (StreamWriter sw = new StreamWriter(BIN_PATH + "BuildResourcesFiles_" + VersionMgr.instance.appVersion + ".json"))
        {
            sw.Write(jsonStr);
        }
    ...
    public static JsonData GetOriginalLuaframeworkMD5Json()
    {
        ...
        foreach (var sourceDir in sourceDirs)
        {
            ...
            foreach (var luaFile in fileList)
            {
                ...
                var md5 = PublicUtil.Util.md5file(luaFile);
    ...
    public static void CopyLuaToBundleDir(List<string> luaFiles, string luabundleDir)
    {
        foreach (var luaFile in luaFiles)
        {
            ...
            var targetFile = luaFile.Replace("Assets/AssetBundle/LuaScripts", "");
